...
function getStartCards() {
	var C = { // as Construcors
	    c001: {owner: 'pA', type: 'N', ah: 7, sh: 3, ai: 3, si: 0, img: 4 , elements: 'A' },
	    c002: {owner: 'pA', type: 'N', ah: 6, sh: 3, ai: 3, si: 2, img: 5 , elements: 'F' },
	    c003: {owner: 'pA', type: 'N', ah: 9, sh: 0, ai: 8, si: 0, img: 6 , elements: 'LA'},
	    c004: {owner: 'pA', type: 'N', ah: 9, sh: 9, ai: 9, si: 9, img: 7 , elements: 'L' },
	    c005: {owner: 'pA', type: 'N', ah: 1, sh: 0, ai: 3, si: 1, img: 8 , elements: 'L' },
	    c006: {owner: 'pA', type: 'N', ah: 6, sh: 2, ai: 4, si: 1, img: 9 , elements: 'A' },
	    c007: {owner: 'pA', type: 'N', ah: 6, sh: 3, ai: 2, si: 2, img: 10, elements: 'A' },
	    
	    c101: {owner: 'pB', type: 'N', ah: 7, sh: 3, ai: 3, si: 0, img: 4 , elements: 'A' },
	    c102: {owner: 'pB', type: 'N', ah: 6, sh: 3, ai: 3, si: 2, img: 5 , elements: 'F' },
	    c103: {owner: 'pB', type: 'N', ah: 9, sh: 0, ai: 8, si: 0, img: 6 , elements: 'LA'},
	    c104: {owner: 'pB', type: 'N', ah: 9, sh: 9, ai: 9, si: 9, img: 7 , elements: 'L' },
	    c105: {owner: 'pB', type: 'N', ah: 1, sh: 0, ai: 3, si: 1, img: 8 , elements: 'L' },
	    c106: {owner: 'pB', type: 'N', ah: 6, sh: 2, ai: 4, si: 1, img: 9 , elements: 'A' },
	    c107: {owner: 'pB', type: 'N', ah: 6, sh: 3, ai: 2, si: 2, img: 10, elements: 'A' },
	};
	return C;
}
